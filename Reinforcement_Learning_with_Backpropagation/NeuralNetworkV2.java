...
public class NeuralNetworkV2 {
    ...
    static int inputSize = 6;  // The additional one is the bias term
    static int hiddenSize = 10; // The additional one is the bias term
    static int outputSize = 1;
    final double bias = 1.0;

    public NeuralNetworkV2 (int inputA, int inputB, int inputNum, int outputNum, int hiddenNum,
