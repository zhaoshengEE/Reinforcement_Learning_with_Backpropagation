...
public class LookUpTableV2 {
    ...
    /* Constructor */
    public LookUpTableV2(int inputASize, int inputBSize, int inputCSize, int inputDSize, int inputESize){
